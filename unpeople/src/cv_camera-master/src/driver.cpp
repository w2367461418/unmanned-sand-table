...
/*
  if (private_node_.getParam("image_width", 1280))
  {
    if (!camera_->setWidth(1280))
    {
      ROS_WARN("fail to set image_width");
    }
  }
  if (private_node_.getParam("image_height", 720))
  {
    if (!camera_->setHeight(720))
    {
      ROS_WARN("fail to set image_height");
    }
  }
